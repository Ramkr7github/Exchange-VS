...
const Trusted = () => {
  return (
    <div>
        <div className='bg-[#0f0e0e] flex flex-col sm:flex-row justify-center items-center gap-x-[60px] w-[550px] sm:w-full'>
            <div className='px-32 py-8' data-aos="fade-right" data-aos-duration="2000">
                ...
                <div className='text-[#fff]'>
                    <h4 className='text-white my-1 uppercase'>This is most SECURE site among its competitors</h4>
